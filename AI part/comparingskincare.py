...
#Reference: rosagradilla19/skincare-products-recommendation-system (2021). Available at: https://github.com/rosagradilla19/skincare-products-recommendation-system (Accessed: 2 May 2021).
...
st.markdown('<style>h1{color: #e75480; }</style>', unsafe_allow_html=True)

st.title('Find the Right Skin Product for You!!')




# Load the data
df = pd.read_csv("C:\\xampp\\xampp\\htdocs\\skinsolutions\\AI part\\data\\cosmetics.csv")

# For Choosing product category
